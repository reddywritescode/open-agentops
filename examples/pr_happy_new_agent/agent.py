...
def support_agent(payload: dict) -> dict:
    order_id = str((payload.get("context") or {}).get("order_id") or "order_2001")
    ...
    request_approval("payments.refund", {"charge_id": duplicate["id"], "amount_cents": duplicate["amount_cents"]})
    return {
        "output": "Duplicate charge found. An approval request was created before any refund.",
